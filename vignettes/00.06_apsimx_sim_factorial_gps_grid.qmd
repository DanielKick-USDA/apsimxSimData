...
soils_i <- closest_soils_list_entry(ith_lon = ith_lon,
                         ith_lat = ith_lon)
# soils_df[soils_i, ]
soils_list[[soils_i]]
...
# and on factorial
res <- apsimx(
    file = 'SimulateFactorial_Tiny.apsimx',
    src.dir = '../data/soil_bespoke/',
    value = "all")
...
plot(
res$Report[, 'yield_Kgha'], 
res2$Report[, 'yield_Kgha'])
```
